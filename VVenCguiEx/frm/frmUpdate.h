...
#pragma endregion
    ...
    public:
        ...
        System::Void startCheck() {
            ...
            auoSetupCtrl->checkAsync(checkFin + gcnew VVenCguiEx::DelegateProcessFin(this, &frmUpdate::frmCheckFinished));
    ...
    private:
        System::Void frmMessage(String^ message) {
            if (this->InvokeRequired) {
                this->Invoke(gcnew VVenCguiEx::DelegateMessage(this, &frmUpdate::frmMessage), message);
                return;
            }
    ...
    private:
        ...
        System::Void frmCheckFinished(String^ message) {
            if (this->InvokeRequired) {
                this->Invoke(gcnew VVenCguiEx::DelegateMessage(this, &frmUpdate::frmCheckFinished), message);
                return;
            }
    ...
    private:
        ...
        System::Void frmUpdateFinished(String^ message) {
            if (this->InvokeRequired) {
                this->Invoke(gcnew VVenCguiEx::DelegateMessage(this, &frmUpdate::frmUpdateFinished), message);
                return;
            }
        ...
        System::Void fruBTUpdate_Click(System::Object^  sender, System::EventArgs^  e) {
            if (0 == String::Compare(fruBTUpdate->Text, L"終了")) {
                ...
                auoSetupCtrl->runAsync(
                    gcnew VVenCguiEx::DelegateMessage(this, &frmUpdate::frmMessage),
                    updateFin + gcnew VVenCguiEx::DelegateProcessFin(this, &frmUpdate::frmUpdateFinished));
